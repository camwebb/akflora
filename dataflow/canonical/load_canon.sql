...
LOAD DATA LOCAL INFILE 'ipni_base' INTO TABLE `names` FIELDS TERMINATED BY '|' ;
...
LOAD DATA LOCAL INFILE 'trop_base' INTO TABLE `tmp_trop` FIELDS TERMINATED BY '|' ;
...
LOAD DATA LOCAL INFILE 'wcsp_base' INTO TABLE `tmp_wcsp` FIELDS TERMINATED BY '|' ;
